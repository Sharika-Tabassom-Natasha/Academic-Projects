<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomT.aspx.cs" Inherits="OnlineClothing.CustomT" %>
...
<!--						      </p>-->								
					      ...
					      <div class="well">
							<ul class="nav">
							    <li class="color-preview" title="Night Black" style="background-color:#000000;"></li>
				    ...
				    <div class="tab-pane" id="tab2">
				    	<div class="well">
							...
							<div id="avatarlist">
								<img style="cursor:pointer;" class="img-polaroid" src="img/customTart1.png">
				                <img style="cursor:pointer;" class="img-polaroid" src="img/customTart2.jpg">
			                    <img style="cursor:pointer;" class="img-polaroid" src="img/customTart3.png">
							</div>	
                            <!--<div>
                                <hr>
